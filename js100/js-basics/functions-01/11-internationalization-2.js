...
// Functions 1 / Exercise 11 / Internationalization 2

/**
 * 11. Building on your solutions from the previous exercises, write a function
...
function localGreet(locale) {
  let localeLangCode = extractLanguage(locale);
  let localeRegion = extractRegion(locale);
