...
// Introduction to Programming / Objects / Exercise 08

/**
 * 08. Create a function that creates and returns a copy of an object. The
...
function copyObj(objForCopying, keysToCopyArr = Object.keys(objForCopying)) {
  let newObj = {};
  
  keysToCopyArr.forEach(prop => newObj[prop] = objForCopying[prop]);
